...
from evidence_sqlmodel import Evidence
from paper_sqlmodel import Paper
...
def main():
    ...
    parser.add_argument(
        "--database-url",
        required=True,
        help="PostgreSQL database URL (e.g., postgresql://user:pass@localhost/dbname)"
    )
    parser.add_argument(
        "--skip-vector-index",
        action="store_true",
        help="Skip creating vector index (useful for development or if embeddings aren't populated yet)"
    )
