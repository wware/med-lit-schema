...
def test_postgres(host: str = "localhost", port: int = 5432, user: str = "postgres", password: str = "postgres", database: str = "medlit", max_retries: int = 5) -> Tuple[bool, str]:
...
def test_redis(host: str = "localhost", port: int = 6379, db: int = 0, max_retries: int = 5) -> Tuple[bool, str]:
...
def main():
    ...
    if pg_success:
        ...
        schema_success, schema_message = create_basic_schema("postgresql://postgres:postgres@localhost:5432/medlit")
