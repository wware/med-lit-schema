...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        *)
            ...
            echo "Usage: $0 [--storage sqlite|postgres] [--database-url URL] [--xml-dir DIR] [--output-dir DIR]"
            exit 1
            ;;
    esac
done
...
echo -e "${BLUE}Stage 3: Extracting biomedical entities${NC}"
echo "--------------------------------------------------------------"
...
# ============================================================================
# Stage 4: Embeddings Generation (Optional, Standalone)
# ============================================================================

echo -e "${BLUE}Stage 4: Generating embeddings${NC}"
echo "--------------------------------------------------------------"
...
echo -e "${BLUE}Stage 5: Extracting relationships (claims)${NC}"
echo "--------------------------------------------------------------"
...
echo -e "${BLUE}Stage 6: Extracting quantitative evidence${NC}"
echo "--------------------------------------------------------------"
...
echo -e "${BLUE}Stage 7: Building knowledge graph${NC}"
echo "--------------------------------------------------------------"
...
echo ""
echo -e "${GREEN}✓ Stage 7 Complete${NC}"
echo ""
