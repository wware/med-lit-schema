...
│   ├── POST                 # Tool invocation requests
│   └── /stream              # Server-Sent Events for long-running operations
│
...
| **MCP** | LLM tool integration, AI-powered research assistants | **Read-only** | 🟡 Emerging (Anthropic-backed) | Growing (Claude, GPT support) |
