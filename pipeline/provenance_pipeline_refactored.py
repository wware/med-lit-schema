#!/usr/bin/env python3
"""
Stage 2: Provenance Extraction Pipeline (Refactored)
...
Usage:
    python provenance_pipeline_refactored.py --xml-dir pmc_xmls --output-dir output --storage sqlite
    python provenance_pipeline_refactored.py --xml-dir pmc_xmls --output-dir output --storage postgres --database-url postgresql://...
"""
