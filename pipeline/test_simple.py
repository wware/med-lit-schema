...
from entity import Paper, Disease, EntityType, EvidenceItem  # noqa: E402
from entity import PaperMetadata, ExtractionProvenance, ExtractionPipelineInfo, ExecutionInfo  # noqa: E402
from relationship import create_relationship  # noqa: E402
from base import PredicateType  # noqa: E402
...
conn.execute("INSERT INTO entities (id, entity_type, name, entity_json) VALUES (?, ?, ?, ?)", (disease.entity_id, disease.entity_type.value, disease.name, disease.model_dump_json()))
conn.commit()
